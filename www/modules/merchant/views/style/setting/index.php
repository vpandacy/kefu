...
<!--                        </div>-->
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label w115">展示消息记录</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label w115">浮窗初始状态</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label w115">新消息强制弹窗</label>
                            <div class="layui-input-block">
...
<!--                        </div>-->
                ...
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        <div class="layui-form-item">
                            <label class="layui-form-label w115" >重复发起</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label w115" >发起语句设置</label>
                        ...
                        <div class="layui-form-item pleft40">
                            <div class="layui-input-block">
